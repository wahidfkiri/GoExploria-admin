                                ...
                                <div class="variant-item card mt-3">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="number" step="0.01" class="form-control-modern" placeholder="Prix +" name="variants[INDEX][price_adjustment]">
                                            </div>
                                            <div class="col-md-2">
                                                <input type="number" class="form-control-modern" placeholder="Stock" name="variants[INDEX][stock]">
                                            </div>
                                            <div class="col-md-2">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h6><i class="fas fa-cubes text-info me-2"></i>Variantes</h6>
                    ...
                    <p>L'image principale sera affichée en premier. Les images de galerie permettent de montrer le produit sous différents angles.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                switch(step) {
                    case 1:
                        if (!typeInput.value) {
                            ...
                            typeInput.scrollIntoView({ behavior: 'smooth' });
                            return false;
                        }
                        return true;
                    case 2:
                        ...
                        return true;
                    case 3:
                        const price = document.getElementById('price_ttc').value;
                        if (!price || price <= 0) {
                            showAlert('danger', 'Le prix doit être supérieur à 0');
                            document.getElementById('price_ttc').focus();
                            return false;
                        }
                        return true;
                    default:
            ...
            function showTypeSpecificFields(type) {
                document.querySelectorAll('.physical-fields, .service-fields, .subscription-fields').forEach(el => {
                    el.style.display = 'none';
                });

                switch(type) {
                    case 'produit_physique':
                        document.querySelector('.physical-fields').style.display = 'block';
                        break;
                    case 'service':
                    case 'prestation':
                        document.querySelector('.service-fields').style.display = 'block';
                        break;
                    case 'abonnement':
                        document.querySelector('.subscription-fields').style.display = 'block';
                        break;
                }
            }
