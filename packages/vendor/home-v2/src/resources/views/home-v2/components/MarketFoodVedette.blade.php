            ...
            <div class="resto-header-main">
                <div class="resto-header-logo-left">
                    <a href="#" class="resto-accord-btn" title="Marche local">
                        <div class="logo-wrapper">
                            <img src="{{ asset('logo.png') }}" alt="Marche local">
                        </div>
                ...
                <div class="resto-header-logo-right">
                    <a href="#" class="resto-accord-btn" title="Marches alimentaires">
                        <div class="logo-wrapper">
                            <img src="{{ asset('plan-n-go.png') }}" alt="Marches alimentaires">
                        </div>
            ...
            <div class="resto-header-destinations-bar">
                <div class="resto-dest-row">
                    ...
                    <div class="resto-dest-breadcrumb">
                        <a href="#" class="resto-dest-link active" data-dest="all">Montreal</a>
                        <span class="resto-dest-sep">/</span>
                        <a href="#" class="resto-dest-link" data-dest="quebec">Quebec</a>
                        <span class="resto-dest-sep">/</span>
                        <a href="#" class="resto-dest-link" data-dest="saguenay">Saguenay</a>
                        <span class="resto-dest-sep">/</span>
                        <a href="#" class="resto-dest-link" data-dest="estrie">Estrie</a>
                    </div>
                </div>
