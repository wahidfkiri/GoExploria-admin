...
<nav class="snb-bar" id="sectionsNavBar" aria-label="{{ __('home-v2.sections_nav.aria') }}">
    <div class="snb-inner">
        <ul class="snb-links">
            <li>
                <a href="#activez-entreprises" class="snb-link">
                    <i class="fas fa-briefcase"></i>
                    <span>Conseils Entreprises</span>
                </a>
            </li>
            <li>
                <a href="#nl-plans" class="snb-link">
                    <i class="fas fa-chart-line"></i>
                    <span>Plans NEXT LEVEL</span>
                </a>
            </li>
            <li>
                <a href="#nl-editeur" class="snb-link">
                    <i class="fas fa-edit"></i>
                    <span>Espace Editeur</span>
                </a>
            </li>
            <li>
