            ...
            <div class="resto-header-destinations-bar">
                <div class="resto-dest-row">
                    ...
                    <div class="resto-dest-breadcrumb vp-dest-breadcrumb">
                        <select id="vp-continent-select" class="vp-dest-select" aria-label="{{ $tr('Continent') }}"></select>
                        <span class="resto-dest-sep">/</span>
                        <select id="vp-country-select" class="vp-dest-select" aria-label="{{ $tr('Pays') }}"></select>
                        <span class="resto-dest-sep">/</span>
                        <select id="vp-province-select" class="vp-dest-select" aria-label="{{ $tr('Province') }}"></select>
                        <span class="resto-dest-sep">/</span>
                        <select id="vp-region-select" class="vp-dest-select" aria-label="{{ $tr('Région') }}"></select>
                    </div>
                </div>
