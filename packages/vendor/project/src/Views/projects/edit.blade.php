    ...
    <main class="dashboard-content">
        ...
        <div class="page-header">
            ...
            <div class="page-actions">
                <a href="{{ route('projects.show', $project) }}" class="btn btn-outline-secondary me-2">
            ...
            <div class="form-step" id="step2">
                <div class="form-card-modern">
                    ...
                    <div class="form-card-body">
                        ...
                        <!-- Client Info Card -->
                        <div class="client-info-card" id="clientInfoCard" style="{{ $project->client_id ? 'display: block;' : 'display: none;' }}">
            ...
            <div class="form-step" id="step3">
                <div class="form-card-modern">
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="budget-preview" id="budgetPreview" style="display: {{ ($project->estimated_hours || $project->hourly_rate) ? 'block' : 'none' }};">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select-modern" id="priority" name="priority">
                                    <option value="low" {{ ($priority ?? 'medium') == 'low' ? 'selected' : '' }}>Basse</option>
                                    <option value="medium" {{ ($priority ?? 'medium') == 'medium' ? 'selected' : '' }}>Moyenne</option>
                                    <option value="high" {{ ($priority ?? 'medium') == 'high' ? 'selected' : '' }}>Haute</option>
                                    <option value="urgent" {{ ($priority ?? 'medium') == 'urgent' ? 'selected' : '' }}>Urgente</option>
                                </select>
                                <small class="form-text-modern text-muted">
