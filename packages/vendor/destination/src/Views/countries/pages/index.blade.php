        ...
        <div class="container-fluid">
            ...
            <div class="tab-content" id="activitiesTabContent">
               ...
               @include('destination::countries.pages.tabs.media')
                ...
                <!-- EVENTS TAB -->
                <div class="tab-pane fade" id="events-tab-pane" role="tabpanel">
                    <div class="card">
                        <div class="card-body text-center py-5">
                            <div class="mb-3">
                                <i class="fas fa-calendar-alt fa-3x text-muted"></i>
                            </div>
                            <h4 class="text-muted">Section Événements</h4>
                            <p class="text-muted">Cette section est en cours de développement.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <td class="activity-name-cell">
                        <div class="activity-name-modern">
                            <div class="activity-icon-modern">
                                ${activity.image ? `<img src="/storage/${activity.image}" alt="${activity.name}" class="activity-img" onerror="this.onerror=null; this.parentElement.innerHTML='<i class=\"fas fa-hiking\"></i>';" style="width: 40px; height: 40px; object-fit: cover; border-radius: 8px;">` : `<i class="fas fa-hiking"></i>`}
                            </div>
                            <div>
