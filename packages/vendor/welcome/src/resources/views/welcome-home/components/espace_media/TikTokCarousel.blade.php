            ...
            <div class="ttk-modal-panel">
                ...
                <div class="ttk-panel-header">
                    <div class="ttk-panel-user">
                        <img loading="lazy" decoding="async" src="{{ asset('logo.png') }}" alt="" class="ttk-panel-avatar" id="ttkPanelAvatar">
                        <div class="ttk-panel-user-info">
                            <div class="ttk-panel-username" id="ttkPanelUsername">
                                <img loading="lazy" decoding="async" src="https://sf16-website-login.neutral.ttwstatic.com/obj/tiktok_web_login_static/tiktok/webapp/main/webapp-desktop/8152caf0c8e8bc67ae0d.png" alt="TikTok" class="ttk-tiktok-icon">
                ...
                <div class="ttk-panel-comments" id="ttkPanelCommentsList">
                    <div class="ttk-comment">
                        <img loading="lazy" decoding="async" src="{{ asset('logo.png') }}" alt="" class="ttk-comment-avatar">
