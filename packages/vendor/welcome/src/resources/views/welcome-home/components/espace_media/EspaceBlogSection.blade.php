            ...
            <div class="resto-header-logo-left">
                <a href="https://wowtheme7.com/tf/kiante/home.html" class="resto-accord-btn" title="Inspiration Kiante" target="_blank" rel="noopener noreferrer">
                    <div class="logo-wrapper">
                        <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1495020689067-958852a7765e?w=200&h=200&fit=crop" alt="Magazine style">
                    </div>
    ...
    <div class="blog-space-container">
        <div class="blog-top-news-area">
            <article class="blog-featured-story" data-blog-type="business">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1400&h=700&fit=crop" alt="Story principale business">
            ...
            <aside class="blog-breaking-column">
                ...
                <article class="blog-mini-post" data-blog-type="business">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=300&h=180&fit=crop" alt="Marketing">
                    <div>
                        <span>Marketing</span>
                ...
                <article class="blog-mini-post" data-blog-type="tech">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=300&h=180&fit=crop" alt="Tech">
                    <div>
                        <span>Tech</span>
                ...
                <article class="blog-mini-post" data-blog-type="travel">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1527631746610-bca00a040d60?w=300&h=180&fit=crop" alt="Travel">
                    <div>
                        <span>Travel</span>
        ...
        <div class="blog-posts-grid" id="blogPostsGrid">
            <article class="blog-post-card" data-blog-type="travel">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=640&h=360&fit=crop" alt="Travel news">
            ...
            <article class="blog-post-card" data-blog-type="tech">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=640&h=360&fit=crop" alt="Tech news">
                <div class="blog-post-body">
                    <span>Tech</span>
            ...
            <article class="blog-post-card" data-blog-type="business">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=640&h=360&fit=crop" alt="Business growth">
                <div class="blog-post-body">
                    <span>Business</span>
