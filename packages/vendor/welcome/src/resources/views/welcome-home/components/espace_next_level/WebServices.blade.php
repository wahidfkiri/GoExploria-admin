        ...
        <div class="resto-header-main">
            ...
            <div class="resto-header-logo-right">
                <a href="#" class="resto-accord-btn" title="{{ $tr('Plans Web Go') }}">
                    <div class="logo-wrapper">
                        <img loading="lazy" decoding="async" src="{{ asset('plan-n-go.png') }}" alt="{{ $tr('Plans Web Go') }}">
                    </div>
    ...
    <div class="ws-container">
            ...
            <div class="web-carousels-grid">
                ...
                <div class="web-carousel-box">
                    ...
                    <div class="web-carousel-content">
                        <div class="web-inner-item">
                            <div class="web-item-circle"><img loading="lazy" decoding="async" src="https://flagcdn.com/w160/eu.png" alt="{{ $tr('Europe') }}"></div>
