        ...
        <div class="vedette-carousel-outer">
            ...
            <article class="events-vedette-v2-card" data-category="culture">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=600&h=400&fit=crop" alt="{{ $tr('Festival d\'été de Québec') }}">
            ...
            <article class="events-vedette-v2-card" data-category="gastronomie">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1555244162-803834f70033?w=600&h=400&fit=crop" alt="{{ $tr('Carnaval de Québec') }}">
                    <div class="events-vedette-v2-card-date">
            ...
            <article class="events-vedette-v2-card" data-category="culture">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&h=400&fit=crop" alt="{{ $tr('Osheaga') }}">
                    <div class="events-vedette-v2-card-date">
            ...
            <article class="events-vedette-v2-card" data-category="nature">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=600&h=400&fit=crop" alt="{{ $tr('Festival des couleurs') }}">
                    <div class="events-vedette-v2-card-date">
            ...
            <article class="events-vedette-v2-card" data-category="aventures">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&h=400&fit=crop" alt="{{ $tr('Festival de montgolfières') }}">
                    <div class="events-vedette-v2-card-date">
            ...
            <article class="events-vedette-v2-card" data-category="culture">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&h=400&fit=crop" alt="{{ $tr('Festival Juste pour rire') }}">
                    <div class="events-vedette-v2-card-date">
            ...
            <article class="events-vedette-v2-card" data-category="gastronomie">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&h=400&fit=crop" alt="{{ $tr('Festival gastronomique') }}">
                    <div class="events-vedette-v2-card-date">
            ...
            <article class="events-vedette-v2-card" data-category="nature">
                <div class="events-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=600&h=400&fit=crop" alt="{{ $tr('Festival des baleines') }}">
                    <div class="events-vedette-v2-card-date">
