            ...
            <div class="resto-header-logo-left">
                <a href="#" class="resto-accord-btn" title="GoExploria Chat">
                    <div class="logo-wrapper">
                        <img loading="lazy" decoding="async" src="{{ asset('logo.png') }}" alt="GoExploria Chat">
                    </div>
        ...
        <div class="chat-single-showcase">
            <div class="chat-single-image-wrap">
                <div class="chat-image-card">
                    <img loading="lazy" decoding="async" src="{{ asset('images/chat.png') }}" alt="Module chat GoExploria principal">
                </div>
                <div class="chat-image-card">
                    <img loading="lazy" decoding="async" src="{{ asset('images/chat-1.png') }}" alt="Module chat GoExploria secondaire">
                </div>
                <div class="chat-image-card">
                    <img loading="lazy" decoding="async" src="{{ asset('images/chat-2.png') }}" alt="Module chat GoExploria secondaire">
                </div>
            </div>
