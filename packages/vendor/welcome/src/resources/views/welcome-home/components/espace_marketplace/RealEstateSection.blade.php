        ...
        <div class="resto-header-main">
            ...
            <div class="resto-header-logo-right">
                <a href="#" class="resto-accord-btn" title="Plans Web Go">
                    <div class="logo-wrapper">
                        <img loading="lazy" decoding="async" src="{{ asset('plan-n-go.png') }}" alt="Plans Web Go">
                    </div>
    ...
    <div class="immo-v2-container">
        ...
        <div class="immo-v2-grid">
            ...
            <article class="immo-v2-card">
                <div class="immo-v2-card-img">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&auto=format&fit=crop&q=70" alt="Appartement moderne">
            ...
            <article class="immo-v2-card">
                <div class="immo-v2-card-img">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&auto=format&fit=crop&q=70" alt="Maison contemporaine">
            ...
            <article class="immo-v2-card">
                <div class="immo-v2-card-img">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&auto=format&fit=crop&q=70" alt="Studio rénové">
            ...
            <article class="immo-v2-card">
                <div class="immo-v2-card-img">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&auto=format&fit=crop&q=70" alt="Duplex terrasse">
        ...
        <div class="immo-v2-agent-cta">
            <div class="immo-v2-agent-info">
                <img loading="lazy" decoding="async" class="immo-v2-agent-img" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&auto=format&fit=crop&q=60" alt="Sophie Martin">
