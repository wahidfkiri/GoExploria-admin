...
<section class="hero-videos-v2-section">
    ...
    <div class="hero-videos-v2-grid">
        <div class="hero-videos-v2-track">
        {{-- Vidéo 1 --}}
    ...
    <div class="hero-videos-v2-modal" id="heroVideoModal" style="display: none;">
        <div class="hero-videos-v2-modal-overlay"></div>
        <div class="hero-videos-v2-modal-content">
            <button class="hero-videos-v2-modal-close" id="closeHeroModal">
            ...
            <div class="hero-videos-v2-modal-body">
                {{-- Lecteur vidéo principal --}}
                <div class="hero-videos-v2-modal-main">
                    <div class="hero-videos-v2-modal-video-wrapper">
                        <iframe 
                            id="heroModalVideoPlayer"
                            class="hero-videos-v2-modal-video"
                            src=""
                            frameborder="0"
