        ...
        <div class="resto-header-main">
            ...
            <div class="resto-header-center">
                <div class="gxt-header-brand gxt-header-brand--hero">
                    <img loading="lazy" decoding="async" src="{{ asset('GO-EXPLORIA-MY-TUBE.png') }}" alt="GoExploria MyTUBE" class="gxt-logo">
                </div>
        ...
        <div class="gxt-card"
            ...
            <div class="gxt-card-body">
                <div class="gxt-avatar">
                    <img loading="lazy" decoding="async" src="{{ asset('GO-EXPLORIA-MY-TUBE.png') }}" alt="{{ $v['channel'] }}" class="gxt-avatar-img">
                </div>
...
(function () {
    ...
    function populateSidebar(current) {
        ...
        visible.forEach(function (c) {
            ...
            item.innerHTML =
                '<img loading="lazy" decoding="async" src="' + c.getAttribute('data-thumb') + '" class="gxt-sidebar-thumb" alt="">' +
