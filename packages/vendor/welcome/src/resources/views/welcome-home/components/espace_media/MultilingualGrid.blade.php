...
<section class="multilingual-v2-section" id="multilingue">
    ...
    <div class="mlg-container">
            ...
            <div class="lang-grid-container">
                ...
                <div class="lang-card">
                    ...
                    <div class="flag-circle">
                        <img loading="lazy" decoding="async" src="https://flagcdn.com/w160/fr.png" alt="{{ $tr('Drapeau Français') }}">
                    </div>
                    <h3>{{ $tr('Français') }}</h3>
                ...
                <div class="lang-card">
                    ...
                    <div class="flag-circle">
                        <img loading="lazy" decoding="async" src="https://flagcdn.com/w160/gb.png" alt="{{ $tr('Drapeau Anglais') }}">
                    </div>
                    <h3>{{ $tr('ANGLAIS') }}</h3>
                ...
                <div class="lang-card">
                    ...
                    <div class="flag-circle">
                        <img loading="lazy" decoding="async" src="https://flagcdn.com/w160/es.png" alt="{{ $tr('Drapeau Espagnol') }}">
                    </div>
                    <h3>{{ $tr('Español') }}</h3>
                ...
                <div class="lang-card">
                    ...
                    <div class="flag-circle">
                        <img loading="lazy" decoding="async" src="https://flagcdn.com/w160/de.png" alt="{{ $tr('Drapeau Allemand') }}">
                    </div>
                    <h3>{{ $tr('ALLEMAND') }}</h3>
            ...
            <div class="lang-grid-container" style="margin-top: 50px; opacity: 0.85;">
                ...
                <div class="lang-card">
                    <span class="lang-status-badge principale">{{ $tr('PRINCIPALE') }}</span>
                    <div class="flag-circle"><img loading="lazy" decoding="async" src="https://flagcdn.com/w160/cn.png" alt="{{ $tr('Drapeau Chinois') }}"></div>
                ...
                <div class="lang-card">
                    <span class="lang-status-badge populaire">{{ $tr('POPULAIRE') }}</span>
                    <div class="flag-circle"><img loading="lazy" decoding="async" src="https://flagcdn.com/w160/in.png" alt="{{ $tr('Drapeau Hindi') }}"></div>
                    <h3>{{ $tr('HINDI INDE') }}</h3>
                ...
                <div class="lang-card">
                    <span class="lang-status-badge nouveau">{{ $tr('NOUVEAU') }}</span>
                    <div class="flag-circle"><img loading="lazy" decoding="async" src="https://flagcdn.com/w160/pt.png" alt="{{ $tr('Drapeau Portugal') }}"></div>
                    <h3>{{ $tr('PORTUGAIS') }}</h3>
                    <p>{{ $tr('Versión internacional. Contenido completo y soporte.') }}</p>
                    <button class="lang-select-btn"><i class="fas fa-globe"></i> {{ $tr('Send') }}</button>
                </div>
                ...
                <div class="lang-card">
                    <span class="lang-status-badge prochaine">{{ $tr('PROCHAINE') }}</span>
                    <div class="flag-circle"><img loading="lazy" decoding="async" src="https://flagcdn.com/w160/sa.png" alt="{{ $tr('Drapeau Arabie') }}"></div>
                    <h3>{{ $tr('ARABE') }}</h3>
                    <p>{{ $tr('Internationale Version. Vollständiger Inhalt.') }}</p>
                    <button class="lang-select-btn"><i class="fas fa-globe"></i> {{ $tr('Send') }}</button>
                </div>
