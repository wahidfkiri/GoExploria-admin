        ...
        <div class="vedette-carousel-outer">
            ...
            <article class="destinations-vedette-v2-card" data-category="patrimoine">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1519112232436-9923c6ba3d26?w=600&h=400&fit=crop" alt="{{ $tr('Vieux-Québec') }}">
                </div>
            ...
            <article class="destinations-vedette-v2-card" data-category="urbain">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1517935706615-2717063c2225?w=600&h=400&fit=crop" alt="{{ $tr('Montréal Métropolitain') }}">
                </div>
                <div class="destinations-vedette-v2-card-content">
            ...
            <article class="destinations-vedette-v2-card" data-category="nature">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop" alt="{{ $tr('Charlevoix') }}">
                </div>
                <div class="destinations-vedette-v2-card-content">
            ...
            <article class="destinations-vedette-v2-card" data-category="nature">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=600&h=400&fit=crop" alt="{{ $tr('Gaspésie') }}">
                </div>
                <div class="destinations-vedette-v2-card-content">
            ...
            <article class="destinations-vedette-v2-card" data-category="plein-air">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1551582045-6ec9c11d8697?w=600&h=400&fit=crop" alt="{{ $tr('Laurentides') }}">
                </div>
                <div class="destinations-vedette-v2-card-content">
            ...
            <article class="destinations-vedette-v2-card" data-category="plein-air">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1605540436563-5bca919ae766?w=600&h=400&fit=crop" alt="{{ $tr('Mont-Tremblant') }}">
                </div>
                <div class="destinations-vedette-v2-card-content">
            ...
            <article class="destinations-vedette-v2-card" data-category="nature">
                <div class="destinations-vedette-v2-card-image">
                    <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600&h=400&fit=crop" alt="{{ $tr('Îles de la Madeleine') }}">
                </div>
                <div class="destinations-vedette-v2-card-content">
