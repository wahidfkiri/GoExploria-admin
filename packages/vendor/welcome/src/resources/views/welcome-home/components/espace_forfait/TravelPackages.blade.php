            ...
            <div class="resto-header-logo-left">
                <a href="{{ $pkgConfig['logo_left']['href'] }}" class="resto-accord-btn" title="{{ $pkgConfig['logo_left']['label'] }}">
                    <div class="logo-wrapper">
                        <img loading="lazy" decoding="async" src="{{ $pkgConfig['logo_left']['src'] }}" alt="{{ $pkgConfig['logo_left']['alt'] }}">
                    </div>
                ...
                <div class="creation-info">
                    <div class="creation-slider" id="creationSlider">
                        <div class="creation-slide active">
                            <img loading="lazy" decoding="async" src="https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600&h=360&dpr=1" alt="Destinations">
                        </div>
                        <div class="creation-slide">
                            <img loading="lazy" decoding="async" src="https://images.pexels.com/photos/3155666/pexels-photo-3155666.jpeg?auto=compress&cs=tinysrgb&w=600&h=360&dpr=1" alt="Voyages en couple">
                        </div>
                        <div class="creation-slide">
                            <img loading="lazy" decoding="async" src="https://images.pexels.com/photos/1371360/pexels-photo-1371360.jpeg?auto=compress&cs=tinysrgb&w=600&h=360&dpr=1" alt="Aventures">
                        </div>
