            ...
            <div class="resto-header-main">
                <div class="resto-header-logo-left">
                    <a href="#" class="resto-accord-btn" title="Location GoExploria">
                        <div class="logo-wrapper">
                            <img loading="lazy" decoding="async" src="{{ asset('logo.png') }}" alt="Location GoExploria">
                        </div>
                ...
                <div class="resto-header-logo-right">
                    <a href="#" class="resto-accord-btn" title="Reservation location">
                        <div class="logo-wrapper">
                            <img loading="lazy" decoding="async" src="{{ asset('plan-n-go.png') }}" alt="Reservation location">
                        </div>
