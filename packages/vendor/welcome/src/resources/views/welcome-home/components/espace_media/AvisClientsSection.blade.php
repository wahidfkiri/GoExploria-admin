...
<section class="avis-clients-section" id="avis-clients">
    ...
    <div class="avis-row avis-row-style-a">
        <article class="avis-card avis-card-a">
            <div class="avis-top">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=120&h=120&fit=crop" alt="Client 1">
                <div>
        ...
        <article class="avis-card avis-card-a">
            <div class="avis-top">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=120&h=120&fit=crop" alt="Client 2">
                <div>
                    <h3>Marc Bouchard</h3>
        ...
        <article class="avis-card avis-card-a">
            <div class="avis-top">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=120&h=120&fit=crop" alt="Client 3">
                <div>
                    <h3>Sophie Gagnon</h3>
