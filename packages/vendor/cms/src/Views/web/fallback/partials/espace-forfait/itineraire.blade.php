<section id="itineraire">
  <div class="container">
    ...
    <div style="margin-top:36px;text-align:center"><a href="{{ $devisLink }}" target="_blank" class="btn btn-outline" style="padding:14px 28px">Voir l’itinéraire complet →</a></div>
  </div>
</section>
