...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--cms-blog-bg);color:var(--cms-blog-text);font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;overflow-x:hidden}a{color:inherit;text-decoration:none}img,video,iframe{max-width:100%}
        ...
        .cms-blog-content{padding:clamp(26px,5vw,58px);font-size:18px;line-height:1.85;color:#273244}
        .cms-blog-content :where(h1,h2,h3,h4,h5,h6){color:var(--cms-blog-text);line-height:1.16;margin:34px 0 14px}.cms-blog-content :where(p,ul,ol,blockquote,figure){margin:0 0 22px}.cms-blog-content a{color:#0b63ce;text-decoration:underline;text-underline-offset:3px}.cms-blog-content blockquote{border-left:4px solid var(--cms-blog-accent);padding:12px 0 12px 20px;background:#fff8e5}.cms-blog-content :where(img,video,iframe){border-radius:16px}
        ...
        @media(max-width:820px){.cms-blog-related-grid{grid-template-columns:1fr}.cms-blog-detail-hero{padding-top:118px}.cms-blog-content{font-size:16px}.cms-blog-shell{padding-bottom:56px}}
    </style>
</head>
<body>
