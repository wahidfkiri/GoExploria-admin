...
<body>
    ...
    @include('cms::web.fallback.partials.landing-cms-header')
                    ...
                    @include('cms::web.fallback.partials.landing-food-products')
                    ...
                    @include('cms::web.fallback.partials.landing-food-blog')

                    @include('cms::web.fallback.partials.landing-food-contact')
                </div>
            </div>
        </div>
    </main>
