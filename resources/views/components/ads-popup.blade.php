...
@if($gxAds->isNotEmpty())
<style>
    /* À GAUCHE : le bord droit est pris par la barre de raccourcis
       (welcome-home/partials/side-rail), qui recouvrait la pop-up. */
    #gx-ads-popup{position:fixed;left:20px;right:auto;bottom:20px;z-index:99990;width:320px;max-width:calc(100vw - 32px);background:#fff;border-radius:16px;box-shadow:0 24px 60px rgba(2,6,23,.30);overflow:hidden;opacity:0;visibility:hidden;transform:translateY(18px);transition:opacity .35s ease,transform .35s ease}
